...
public class RegisterFrame {
    ...
    private void initialize() {
        ...
        // DROPDOWN REMOVED. Button moved up to fill the gap.
        JButton btnRegister = new JButton("REGISTER");
        btnRegister.setBounds(97, 400, 315, 53); // Moved up from 480
        ...
        lblBackToLogin.setBounds(151, 480, 220, 16); // Moved up to stay under the button
    ...
    private void handleRegistration() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            pstmt.setString(3, role); // Automatically inserts "Cashier"
