...
public class Laundrify extends JFrame {
    ...
    // ==========================================
    // Structure colors
    private final Color MAIN_SYSTEM_BG = new Color(241, 245, 249); 
    private final Color CARD_HOLDER_BG = Color.WHITE;             
    private final Color BORDER_GRAY = new Color(203, 213, 225);   
    
    // Text colors 
    private final Color SLATE_DARK_TEXT = new Color(30, 41, 59);  
    private final Color PRIMARY_VIBRANT_BLUE = new Color(0, 153, 255); 
    private final Color CHECKOUT_GREEN = new Color(16, 185, 129);      
    private final Color DANGER_BG = new Color(254, 226, 226);          
    private final Color DANGER_TEXT = new Color(153, 27, 27);          
    ...
    public Laundrify(String cashierName) {
        ...
        addServiceButton(servicesGrid, "WASH", "Wash", "washing-machine.png", new Color(71, 85, 105)); 
        addServiceButton(servicesGrid, "DRY", "Dry", "ironing-service.png", new Color(71, 85, 105));  
        addServiceButton(servicesGrid, "FOLD", "Fold", "laundry-service.png", new Color(0, 153, 153));  
        addServiceButton(servicesGrid, "WASH & DRY", "Wash & Dry", "laundry.png", new Color(0, 153, 153)); 
        addServiceButton(servicesGrid, "SELF-SERVE", "Self-Serve", "laundry(1).png", new Color(71, 85, 105)); 
        ...
        // FIX: Added 'loggedInCashier' as the middle parameter
    ...
    private void showAddOnsDialog() {
        ...
        // FETCH DYNAMIC ADD-ONS FROM DATABASE
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Failed to load Add-Ons from Database.", "Database Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void addServiceButton(JPanel panel, String btnText, String itemText, String iconFileName, Color dynamicTileColor) {
        ...
        styleButton(btn, dynamicTileColor, Color.WHITE); 
    ...
    private void saveTransactionAndPrint(double amountPaid, double change) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
             // UPDATED: Now inserts cashier_name
             PreparedStatement pstmt = conn.prepareStatement("INSERT INTO sales (invoice_number, customer_name, customer_phone, items, total_amount, amount_paid, change_amount, cashier_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)")) {
                ...
                pstmt.setString(8, loggedInCashier); // Logs the cashier!
                pstmt.executeUpdate();
        } catch (Exception e) { 
            e.printStackTrace(); 
        }
