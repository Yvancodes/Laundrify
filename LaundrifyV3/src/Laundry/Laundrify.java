...
public class Laundrify extends JFrame {
    ...
    public Laundrify(String cashierName) {
        ...
        addServiceButton(servicesGrid, "WASH", "Wash", "washing-machine.png", new Color(0, 80, 160));
        addServiceButton(servicesGrid, "DRY", "Dry", "ironing-service.png", new Color(0, 80, 160));
        addServiceButton(servicesGrid, "FOLD", "Fold", "laundry-service.png", new Color(0, 102, 204));
        addServiceButton(servicesGrid, "WASH & DRY", "Wash & Dry", "laundry.png", new Color(0, 102, 204));
        addServiceButton(servicesGrid, "SELF-SERVE", "Self-Serve", "laundry(1).png", new Color(0, 80, 160));
        
        JButton btnWeight = new JButton("WEIGHT");
        styleButton(btnWeight, new Color(0, 80, 160), Color.WHITE);
