    ...
    private void loadQueueData(String keyword) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                if (status.equals("Pending")) pendingModel.addRow(new Object[]{id, inv, name, phone, status});
                else if (status.equals("Unclaimed")) unclaimedModel.addRow(new Object[]{id, inv, name, phone, status});
                else if (status.equals("Claimed")) claimedModel.addRow(new Object[]{id, inv, name, phone, status});
            }
